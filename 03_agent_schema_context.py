"""
03_agent_schema_context.py — Avalon University Marketing Ops AI
Updated schema context for the data query agent system prompt.
Paste SCHEMA_CONTEXT into DATA_QUERY_PROMPT in agent_prompts.py.
"""
